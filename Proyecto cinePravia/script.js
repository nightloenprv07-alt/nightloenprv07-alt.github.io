...
document.getElementById("calcular").addEventListener("click", function () {
  ...
  document.getElementById("txt-subtotal").textContent = "Subtotal: " + subtotal.toFixed(2) + " €";
  document.getElementById("txt-iva").textContent = "IVA: " + iva.toFixed(2) + " €";
  document.getElementById("txt-total").textContent = "TOTAL: " + total.toFixed(2) + " €";
...
var imagenes = ["logo.png", "cine.jpg", "torrente.jpg"];
var i = 0;
